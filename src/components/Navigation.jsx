...
const Navigation = () => {
  ...
  const trainingItems = [
    ...
    { id: 'kids-academy', label: 'Code Cubs - Young Learners Growing Coding Skills' },
          ...
          <div className={`nav-links ${isMobileMenuOpen ? 'active' : ''}`}>
            ...
            <div className="nav-dropdown">
              <button 
                ...
                onMouseEnter={() => window.innerWidth > 768 && setIsTrainingDropdownOpen(true)}
              >
                Training
                <span className="dropdown-arrow">▼</span>
              </button>
              <div className={`dropdown-menu ${isTrainingDropdownOpen ? 'active' : ''}`}
                   onMouseEnter={() => window.innerWidth > 768 && setIsTrainingDropdownOpen(true)}
                   onMouseLeave={() => window.innerWidth > 768 && setIsTrainingDropdownOpen(false)}>
